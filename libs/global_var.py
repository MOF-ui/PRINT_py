...
DB_retries = int(cfg['DATABASE']['MAX_RETRIES'])
DB_password = str(cfg['DATABASE']['PASSWORD'])
DB_retry_interval = int(cfg['DATABASE']['RETRY_INTERVAL'])
DB_session = 'unnamed'
DB_token = str(cfg['DATABASE']['TOKEN'])
...
PRH_connected = False
PRH_rapid_name = str(cfg['PRINTHEAD']['RAPID_NAME'])
