...
class Mainframe_test( unittest.TestCase ):
    ...
    def test_addSIB( self ):
        ...
        self.assertEqual( UTIL.SC_queue.display()
                         ,[ UTIL.QEntry( id= 1, Coor1= UTIL.Coordinate( x= 1, y= 2, z= 3, ext= 500 ), Speed= UTIL.SpeedVector( ts= 400 ) ).printShort()
                           ,UTIL.QEntry( id= 2, Coor1= UTIL.Coordinate( x= 6, y= 7, z= 8, ext= 990 ), Speed= UTIL.SpeedVector( ts= 900 ) ).printShort()
                           ,UTIL.QEntry( id= 3, pt= 'Q', Coor1= UTIL.Coordinate( x= 1.1, y= 2.2, z= 3.3, rx= 4.4, ry= 5.5, rz= 6.6, q= 7.7, ext= 600 ), Speed= UTIL.SpeedVector( ts= 18, os= 19, acr= 20, dcr= 21 ), z= 50 ).printShort() 
                           ,UTIL.QEntry( id= 4, mt= 'J', Coor1= UTIL.Coordinate( x= 8, y= 8, z= 9, ext= 160 ), Speed= UTIL.SpeedVector( ts= 110, os= 120, acr= 130, dcr= 140 ), z= 15 ).printShort() ] )
        
        UTIL.DC_currZero = UTIL.Coordinate( x= 1 )
        testFrame.addSIB( number= 3, atEnd= False )
        self.assertEqual( UTIL.SC_queue.display()
                         ,[ UTIL.QEntry( id= 1, pt= 'Q', Coor1= UTIL.Coordinate( x= 1.1, y= 2.2, z= 3.3, rx= 4.4, ry= 5.5, rz= 6.6, q= 7.7, ext= 600 ), Speed= UTIL.SpeedVector( ts= 18, os= 19, acr= 20, dcr= 21 ), z= 50 ).printShort()
                           ,UTIL.QEntry( id= 2, mt= 'J', Coor1= UTIL.Coordinate( x= 8, y= 8, z= 9, ext= 160 ), Speed= UTIL.SpeedVector( ts= 110, os= 120, acr= 130, dcr= 140 ), z= 15 ).printShort()
                           ...
                           ,UTIL.QEntry( id= 5, pt= 'Q', Coor1= UTIL.Coordinate( x= 1.1, y= 2.2, z= 3.3, rx= 4.4, ry= 5.5, rz= 6.6, q= 7.7, ext= 600 ), Speed= UTIL.SpeedVector( ts= 18, os= 19, acr= 20, dcr= 21 ), z= 50 ).printShort()
                           ,UTIL.QEntry( id= 6, mt= 'J', Coor1= UTIL.Coordinate( x= 8, y= 8, z= 9, ext= 160 ), Speed= UTIL.SpeedVector( ts= 110, os= 120, acr= 130, dcr= 140 ), z= 15 ).printShort() ] )
