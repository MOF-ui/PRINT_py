...
class FuncLibTest(unittest.TestCase):
    ...
    def test_gcode_to_qentry_function(self):
        ...
        TestEntry = du.QEntry(
            Coor1=du.Coordinate(1, 1, 1, 1, 1, 1, 1, 1),
        ...
        g.ROBCurrZero = du.Coordinate(4, 4, 4, 4, 4, 4, 4, 4)

        test_txt = 'G1 X5.5 Y6 EXT7 F80 TRL0.1 TCL1 TCU1 TPS0 TLS1'
        self.assertEqual(
            fu.gcode_to_qentry(TestEntry, test_txt),
            (
        ...
        test_txt = 'G92 X0 Y0'
        fu.gcode_to_qentry(TestEntry, test_txt),
        self.assertEqual(g.ROBCurrZero, du.Coordinate(1, 1, 4, 4, 4, 4, 4, 4))
    ...
    def test_show_on_terminal_function(self):
        ...
        self.assertEqual(g.TERM_log, ['1'])

        fu.add_to_comm_protocol('2')
        self.assertEqual(g.TERM_log, ['2'])
        g.TERM_MAX_LINES = 200
