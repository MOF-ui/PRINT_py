    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        with conn:
            ...
            while True:
                ...
                RecvEntry.Speed.ela = struct.unpack("<i", data[70:74])[0]
                RecvEntry.Speed.eoa = struct.unpack("<i", data[74:78])[0]
                RecvEntry.Speed.tcp = struct.unpack("<i", data[78:82])[0]
                RecvEntry.Speed.tor = struct.unpack("<i", data[82:86])[0]
